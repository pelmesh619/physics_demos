...
class Main {
    ...
    reloadModel() {
        ...
        document.getElementById('omega_1').innerText = toScientificNotation(Math.sqrt(Constants.g / values.L)) + ' рад/с'
        document.getElementById('omega_2').innerText = toScientificNotation(Math.sqrt(Constants.g / values.L + (2 * values.k * values.L1**2) / (values.m * values.L**2))) + ' рад/с'
